  ...
  return (
    <AuthShell title="Welcome back" showBack={false} showLogo>
      <ClubField label="EMAIL">
        <ClubInput testID="signIn.email" value={email} onChangeText={setEmail} autoComplete="email" textContentType="username" keyboardType="email-address" placeholder="Email address" />
      </ClubField>
      <ClubField label="PASSWORD" error={error ?? undefined}>
        <ClubPasswordInput testID="signIn.password" value={password} onChangeText={setPassword} autoComplete="password" textContentType="password" onSubmitEditing={submit} />
      </ClubField>
