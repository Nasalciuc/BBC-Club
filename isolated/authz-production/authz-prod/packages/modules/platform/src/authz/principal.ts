...
/** Exactly one of these per request or per handler invocation. */
...
/** The member a scoped repository must use. Members act for themselves; system handlers act for the event's actor. Never from the client. */
