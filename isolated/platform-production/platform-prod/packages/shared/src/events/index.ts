import { z } from "zod";
import { MemberRegisteredV1, MemberEmailVerifiedV1, MemberPasswordChangedV1, MemberDeletedV1, MemberLinkedToCrmV1, MemberProfileUpdatedV1 } from "./member";
...
} as const satisfies Record<string, { version: number; schema: z.ZodTypeAny; upcasters?: Record<number, (p: any) => any>; noConsumer?: boolean }>;

export type EventType = keyof typeof EVENT_CATALOGUE;
export * from "./member"; export * from "./offer"; export * from "./notification"; export * from "./crm";
