...
export const candidateStatus = personalization.enum("candidate_status", [
  "suggested",
  "accepted",
  "rejected",
  "expired",
...
export const proposalCandidates = personalization.table(
  "proposal_candidates",
  {
    id: id(),
  ...
  (t) => [
    ...
    index("candidates_open")
      .on(t.createdAt)
      .where(sql`${t.status} = 'suggested'`),
